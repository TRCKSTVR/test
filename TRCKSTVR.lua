...
local function createOptions()
    ...
    local function rotationOptions()
        ...
        br.ui:createSpinner(section, "Vivify", 75, 1, 100, 5, "Health Percent to Cast At")
        br.ui:createSpinnerWithout(section, "Vivify Spam", 2, 1, 20, 1, "Amount of Renewing Mists rolling before switching to vivify")
